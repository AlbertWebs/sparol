...
Route::get('/about-us/team','HomeController@about_team');
Route::get('/our-services','HomeController@services');
Route::get('/our-services/{title}','HomeController@service');
Route::get('/media-center/{slung}','HomeController@media');
Route::get('/media-centers/{slung}','HomeController@medias');
Route::get('/our-sectors','HomeController@sectors');
Route::get('/our-properties','HomeController@properties');
Route::get('/properties/{type}','HomeController@properties_type');

Route::get('/our-properties/{title}','HomeController@property');
Route::get('/our-sectors/{title}','HomeController@sector');
...
Route::get('/serviceSlung','AdminsController@serviceSlung');
...
Route::get('/editPartners/{id}', 'AdminsController@editPartners');
Route::get('/deletePartners/{id}', 'AdminsController@deletePartners');
...
//Privacy
Route::get('/media','AdminsController@media');
Route::get('/editMedia/{id}', 'AdminsController@editMedia');
Route::get('/delete_media/{id}','AdminsController@delete_media');
Route::post('/edit_media/{id}', 'AdminsController@edit_media');
...
// Add Section
//Services
Route::get('/section','AdminsController@section');
Route::get('/deleteSection/{id}','AdminsController@deleteSection');
Route::post('/edit_Section/{id}', 'AdminsController@edit_Section');
Route::get('/editSections/{id}', 'AdminsController@editSection');
Route::get('/addSection', 'AdminsController@addSection');
Route::post('/add_Section', 'AdminsController@add_Section');
...
Route::get('/section/service/{id}/', 'AdminsController@theservices');
...
//Amenities
Route::get('/editAmenities/{id}','AdminsController@editAmenities');
Route::post('/edit_Amenities/{id}', 'AdminsController@edit_Amenities');
