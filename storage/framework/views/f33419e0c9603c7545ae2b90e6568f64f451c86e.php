              ...
              <div class="row">
               <center>
				...
				<?php endif; ?>
                 ...
                 <form class="form-horizontal" method="post"  action="<?php echo e(url('/admin/save_gallery')); ?>/<?php echo e($Gallery->id); ?>" enctype="multipart/form-data">
                    
                 <div class="form-group">
                        <label for="text1" class="control-label col-lg-4">Image Title</label>

                        <div class="col-lg-8">
                            <input type="text" id="text1" name="title" value="<?php echo e($Gallery->title); ?>" placeholder="e.g Designekta Studios" class="form-control" />
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="box">
                                ...
                                <div id="div-1" class="body collapse in">
                                        ...
                                        <textarea name="content" id="wysihtml5" class="form-control" rows="10"><?php echo e($Gallery->content); ?></textarea>
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="">
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="<?php echo e(url('/')); ?>/uploads/gallery/<?php echo e($Gallery->image); ?>" alt="" /></div>
                    ...
                    <input type="hidden" name="image_cheat" value="<?php echo e($Gallery->image); ?>">
