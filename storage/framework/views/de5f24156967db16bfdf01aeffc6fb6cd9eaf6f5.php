                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <?php $__currentLoopData = $Gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td><center><img width="200" height="200" src="<?php echo e(url('/')); ?>/uploads/gallery/<?php echo e($value->image); ?>"></center></td>
                                                    <td class="center"><a href="<?php echo e(url('/admin')); ?>/editGallery/<?php echo e($value->id); ?>"  class="btn btn-info"><i class="icon-pencil icon-white"></i> Edit</a></td>
                                                    <td class="center"><a onclick="return confirm('Delete This Item?')" href="<?php echo e(url('/admin')); ?>/deleteGallery/<?php echo e($value->id); ?>"   class="btn btn-danger"><i class="icon-trash icon-white"></i> Del</a></td>
                                                </tr>
