              ...
              <div class="row">
               <center>
				...
				<?php endif; ?>
                 ...
                 <form class="form-horizontal" method="post"  action="<?php echo e(url('/admin/edit_Services')); ?>/<?php echo e($Services->id); ?>" enctype="multipart/form-data">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <select name="section_id" data-placeholder="Choose a Section" class="form-control chzn-select" tabindex="2">
                           <option value="<?php echo e($Services->section_id); ?>"><?php $Section = DB::table('sections')->where('id',$Services->section_id)->get();  ?><?php $__currentLoopData = $Section; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Sec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php echo e($Sec->title); ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <textarea id="limiter" name="meta" class="form-control"><?php echo e($Services->pre); ?></textarea>
