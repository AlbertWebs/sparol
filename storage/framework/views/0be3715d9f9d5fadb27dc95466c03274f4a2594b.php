            ...
            <div class="inner" style="min-height: 700px;">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <center> <h2> Add Section </h2> </center>
                    </div>
                </div>
                  <hr />
                 <!--BLOCK SECTION -->
              ...
              <div class="row">
               <center>
				...
				<?php endif; ?>
                 ...
                 <form class="form-horizontal" method="post"  action="<?php echo e(url('/admin/add_Section')); ?>" enctype="multipart/form-data">
                    
                 <div class="form-group">
                        <label for="text1" class="control-label col-lg-4">Section Name</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            ...
                            <p class="help-block">Add Limited Words To Describe The Section</p>
                        </div>
                    </div>
                    ...
                    <br><br>
                    <div class="col-lg-12 text-center">
                      <button type="submit" class="btn btn-success"><i class="icon-plus icon-white"></i> Add Section</button>
                    </div>
