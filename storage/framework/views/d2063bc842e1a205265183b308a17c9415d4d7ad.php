                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <?php $__currentLoopData = $Terms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td class="center"><a href="<?php echo e(url('/admin')); ?>/editTerm/<?php echo e($value->id); ?>"  class="btn btn-info"><i class="icon-pencil icon-white"></i> Edit</a></td>
                                                    <td class="center"><a onclick="return confirm('Delete This Item?')" href="<?php echo e(url('/admin')); ?>/delete_term/<?php echo e($value->id); ?>"   class="btn btn-danger"><i class="icon-trash icon-white"></i> Del</a></td>
                                                </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                
                                            </tbody>
                                            <center><a class="btn btn-info icon-plus" href="<?php echo e(url('admin/addTerms')); ?>">Add Term</a></center>
                                        </table>
                                    </div>
