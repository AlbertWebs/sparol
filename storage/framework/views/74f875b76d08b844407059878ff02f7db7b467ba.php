<div id="right">
            ...
            <div class="well well-small">
                ...
                <button type="button" onclick="window.open('<?php echo e(url('/admin/media')); ?>','_self')" class="btn btn-success btn-block"> Media </button>

                <button type="button" onclick="window.open('<?php echo e(url('/admin/slider')); ?>','_self')" class="btn btn-primary btn-block"> Sliders</button>
                <button type="button" onclick="window.open('<?php echo e(url('/admin/galleryList')); ?>','_self')" class="btn btn-primary btn-block"> Photo Gallery</button>
