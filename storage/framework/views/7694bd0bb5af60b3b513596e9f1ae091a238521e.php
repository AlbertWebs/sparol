                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 col wow fadeInUp" data-wow-delay=".<?php echo e($count); ?>s">
                        <div class="service-wrap mb-30">
                            ...
                            <div class="service-content">
								...
								<center>
                                <a class="btn btn-primary text-center" href="<?php echo e(url('/')); ?>/our-sectors/<?php echo e($Sect->slung); ?>">Read More</a>
								</center>
                            </div>
                        </div>
					</div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 col wow fadeInUp" data-wow-delay=".<?php echo e($count); ?>s" >
                        <div class="blog-wrap mb-30">
                            ...
                            <div class="blog-content">
                                ...
                                <h3 class="text-center"><a href="<?php echo e(url('/our-properties')); ?>/<?php echo e($pro->slung); ?>"><?php echo e($pro->name); ?></a></h3>
                                ...
                                <center><a  href="<?php echo e(url('/our-properties')); ?>/<?php echo e($pro->slung); ?>" class="btn-style">Explore</a></center>
                            </div>
                        </div>
                    </div>
                    <?php else: ?>
