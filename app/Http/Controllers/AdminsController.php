...
public function add_Product(Request $request){
    ...
    $Product->rentsale = $request->rentsale;
    ...
    $ProductLast = DB::table('product')->orderBy('id', 'desc')->first();
    echo $ProductLast->id;
    // Insert Amenities
    $Amenity = new Amenity;
    $Amenity->product_id = $ProductLast->id;
    $Amenity->save();
...
public function deleteProduct($id){
    ...
    DB::table('amenities')->where('product_id',$id)->delete();
    return Redirect::back();
}
...
public function serviceSlung(){
    $Services = DB::table('product')->get();
    foreach($Services as $service){
        $slung = str_slug($service->name);

        $updateDetails = array(
            'slung' => $slung,        
        );

    DB::table('product')->where('id',$service->id)->update($updateDetails);
...
public function add_Section(Request $request){
    ...
    $Section->pre = $request->meta;
    $Section->content = $request->content;
    $Section->image = $image_one;

    
    $Section->save();
  
    Session::flash('message', "Section Has Been Added");
    return Redirect::back();
}
...
public function section(){
    ...
    $page_title = 'list';
    $page_name = 'Sections';
    return view('admin.sections',compact('page_title','Sections','page_name'));
}
...
public function editSection($id){
    ...
    return view('admin.editSection',compact('page_title','Sections','page_name'));
}
...
public function deleteSection($id){
    $Testimonials = DB::table('testimonial')->where('section_id',$id)->get();
    foreach($Testimonials as $tes){
        DB::table('testimonial')->where('section_id',$id)->delete();
    }
    $Service = DB::table('services')->where('section_id',$id)->get();
    foreach($Service as $ser){
        DB::table('portfolio')->where('service',$id)->delete();
    }
    foreach($Service as $ser){
...
public function addPortfolio(){
    ...
    $Section = Section::all();
    return view('admin.addPortfolio',compact('page_title','page_name','Section'));
}
...
public function editPortfolio($id){
    ...
    return view('admin.editPortfolio',compact('page_title','Portfolio','page_name','Section'));
}
...
public function addTestimonial(){
    ...
    $Section = Section::all();
    return view('admin.addTestimonial',compact('page_title','page_name','Section'));
}
...
public function editTestimonial($id){
    ...
    $Section = Section::all();
    return view('admin.editTestimonial',compact('page_title','Testimonial','page_name','Section'));
}
...
public function addPartner(){
    ...
    $Section = Section::all();
    return view('admin.addPartner',compact('page_title','page_name','Section'));
}
...
public function add_Partner(Request $request){
    ...
    $Partner->section = $request->section;
...
public function editPartners($id){
    ...
    return view('admin.editPartner',compact('page_title','Partner','page_name','Section'));
}
...
public function addTeam(){
    $page_name = 'Add Site Team Members';
    $page_title = 'formfiletext';//For Style Inheritance
...
public function add_Team(Request $request){
    ...
    if(isset($request->image)){
        ...
        $Team->image = $image;
        $Team->save();
        Session::flash('message', "$request->name has been added as new Team");
        return Redirect::back();
...
public function team(){
    $page_title = 'list';
    $page_name = 'Site Team Member';
    $Team = Team::all();
    return view('admin.team',compact('page_title','Team','page_name'));
}

public function editTeam($id){
    $newID = Auth::user()->id;
    $Team = Team::find($newID);
    $page_title = 'formfiletext';//For Style Inheritance
    $page_name = 'Edit Site Teamistrator';
   
    return view('admin.editTeam',compact('page_title','Team','page_name'));
}
...
public function theservices(Request $request, $id) {
    if($id == "all"){
        if ($request->ajax()) {
...
public function editAmenities($id){
    $Amenities  = DB::table('amenities')->where('product_id',$id)->get();
    $Product = Product::find($id);
    $page_title = 'formfiletext';//For Style Inheritance
    $page_name = 'Amenities';
   
    return view('admin.editAmenities',compact('page_title','Amenities','page_name','Product'));
...
public function edit_Amenities(Request $request, $id){
    ...
    $updateDetails = array(
        ...
        'cctv' => $request->cctv,
        'electric_fence' => $request->electric_fence,
        'perimeter_wall' => $request->perimeter_wall,
        'power_supply' => $request->power_supply,
        'restaurants' => $request->restaurants,
        'Standby_generator' => $request->Standby_generator,
        ...
        'master_ensuite' => $request->master_ensuite,
        'gated_community' => $request->gated_community,
        'fully_furnished' => $request->fully_furnished,
        'elevator' => $request->elevator
    );
    DB::table('amenities')->where('product_id',$id)->update($updateDetails);
    Session::flash('message', "Your Changes Have Been Saved");
    return Redirect::back();
}
// media
public function media(){
    ...
    $page_name = 'Media';
    $page_title = 'list';
    return view('admin.media',compact('page_title','Media','page_name'));
}
...
public function editMedia($id){
    ...
    foreach ($Media as $key => $value) {
        $page_name = $value->title;
        $page_title = 'formfiletext';//For Style Inheritance
        return view('admin.editMedia')->with('Media',$Media)->with('page_name',$page_name)->with('page_title',$page_title);
    }
...
public function edit_media(Request $request, $id){
   ...
   DB::table('media')->where('id',$id)->update($updateDetails);
   Session::flash('message', "Changes have been saved");
    return Redirect::back();
}
