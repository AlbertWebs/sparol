<div id="right">
            ...
            <div class="well well-small">
                ...
                <button type="button" onclick="window.open('{{url('/admin/section')}}','_self')" class="btn btn-danger btn-block"> Sections</button>
                <button type="button" onclick="window.open('{{url('/admin/services')}}','_self')" class="btn btn-info btn-block"> Services</button>
                ...
                <button type="button" onclick="window.open('{{url('/admin/partners')}}','_self')" class="btn btn-success btn-block"> Partners </button>

                <button type="button" onclick="window.open('{{url('/admin/media')}}','_self')" class="btn btn-success btn-block"> Media </button>

                <button type="button" onclick="window.open('{{url('/admin/slider')}}','_self')" class="btn btn-primary btn-block"> Sliders</button>
                <button type="button" onclick="window.open('{{url('/admin/galleryList')}}','_self')" class="btn btn-primary btn-block"> Photo Gallery</button>
                
                <button type="button" onclick="window.open('{{url('/admin/products')}}','_self')" class="btn btn-success btn-block"> Properties</button>
                <button type="button" onclick="window.open('{{url('/admin/banner')}}','_self')" class="btn btn-primary btn-block"> Banners</button>
                <button type="button" onclick="window.open('{{url('/admin/values')}}','_self')" class="btn btn-defaut btn-block"> Values</button>
                <button type="button" onclick="window.open('{{url('/admin/files')}}','_self')" class="btn btn-primary btn-block"> Busines Profiles</button>
