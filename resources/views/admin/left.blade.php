<div id="left" >
            ...
            <ul id="menu" class="collapse">
                ...
                <li><a href="{{url('admin/addSection')}}"><i class="icon-plus"></i>  <i class="icon-folder-open"></i> Add Section </a></li>
                ...
                <li><a href="{{url('admin/addProduct')}}"><i class="icon-plus"></i>  <i class="icon-group"></i> Add Propeties </a></li>
                <li><a href="{{url('admin/addPartner')}}"><i class="icon-plus"></i>  <i class="icon-group"></i> Add Partners </a></li>
                <li><a href="{{url('admin/addSlider')}}"><i class="icon-plus"></i>  <i class="icon-film"></i> Add Slider </a></li>
                <li><a href="{{url('admin/addTeam')}}"><i class="icon-plus"></i>  <i class="icon-user"></i> Add Team Member</a></li>
                <li><a href="{{url('admin/addSlider')}}"><i class="icon-plus"></i>  <i class="icon-film"></i> Add Slider </a></li>
