				...
				@endif
                 ...
                 <form class="form-horizontal" method="post"  action="{{url('/admin/add_Team')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="text1" class="control-label col-lg-4">Members Name</label>

                        <div class="col-lg-8">
                            <input type="text" id="text1" name="name" value="" placeholder="e.g Collins Magak " class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" id="text1" name="position" value="" placeholder="e.g Managing Director " class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" id="text1" name="facebook" value="" placeholder="e.g http://facebook.com/albert.muhatex " class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12 text-center">
                      <button type="submit" class="btn btn-success"><i class="icon-plus icon-white"></i> Add Member</button>
                    </div>
