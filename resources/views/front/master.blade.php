...
@foreach($Sitesettings as $Settings)
    <head>
        ...
        <link rel="apple-touch-icon" sizes="57x57" href="{{asset('theme/favicon/apple-icon-57x57.png')}}">
        <link rel="apple-touch-icon" sizes="60x60" href="{{asset('theme/favicon/apple-icon-60x60.png')}}">
        <link rel="apple-touch-icon" sizes="72x72" href="{{asset('theme/favicon/apple-icon-72x72.png')}}">
        <link rel="apple-touch-icon" sizes="76x76" href="{{asset('theme/favicon/apple-icon-76x76.png')}}">
        <link rel="apple-touch-icon" sizes="114x114" href="{{asset('theme/favicon/apple-icon-114x114.png')}}">
        <link rel="apple-touch-icon" sizes="120x120" href="{{asset('theme/favicon/apple-icon-120x120.png')}}">
        <link rel="apple-touch-icon" sizes="144x144" href="{{asset('theme/favicon/apple-icon-144x144.png')}}">
        <link rel="apple-touch-icon" sizes="152x152" href="{{asset('theme/favicon/apple-icon-152x152.png')}}">
        <link rel="apple-touch-icon" sizes="180x180" href="{{asset('theme/favicon/apple-icon-180x180.png')}}">
        <link rel="icon" type="image/png" sizes="192x192"  href="{{asset('theme/favicon/android-icon-192x192.png')}}">
        <link rel="icon" type="image/png" sizes="32x32" href="{{asset('theme/favicon/favicon-32x32.png')}}">
        <link rel="icon" type="image/png" sizes="96x96" href="{{asset('theme/favicon/favicon-96x96.png')}}">
        <link rel="icon" type="image/png" sizes="16x16" href="{{asset('theme/favicon/favicon-16x16.png')}}">
        <link rel="manifest" href="{{asset('theme/favicon/manifest.json')}}">
        <meta name="msapplication-TileColor" content="#ffffff">
        <meta name="msapplication-TileImage" content="{{asset('theme/favicon/ms-icon-144x144.png')}}">
     ...
     <meta name="keywords" content="Sparol Solutions Group, 
         ...
         @foreach($TheeSectors as $theSect){{$theSect->title}},@endforeach
     " />
     ...
     <meta property="og:image:secure_url" content="{{url('/')}}/uploads/logo/{{$Settings->logo}}">
     ...
     <meta name="twitter:image" content="{{url('/')}}/uploads/logo/{{$Settings->logo}}">
        {{--  --}}
...
<!-- End Facebook Pixel Code -->
    ...
    <body>
                    ...
                    <div class="row">
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <div class="header-top-left">
                                <p style="color:#6cd6fa; font-weight:900">{{$Settings->tagline}} &nbsp; &nbsp; <span class="fa fa-phone text-center"></span>&nbsp; {{$Settings->mobile_one}} &nbsp; &nbsp; <span class="fa fa-phone text-center"></span> &nbsp;{{$Settings->mobile}} &nbsp; &nbsp; <span class="fa fa-envelope text-center"></span>&nbsp;  {{$Settings->email}}</p>
                            </div>
                        </div>
                ...
                <div class="container">
    				...
    				<div class="row">
                        <div class="col-md-3 col-sm-8 col-xs-6">
    						<div class="logo">
    							<h1><a href="{{url('/')}}"><img src="{{url('/')}}/uploads/logo/{{$Settings->logo}}" alt="{{$Settings->sitename}}"></a></h1>
    						</div>
    					</div>
    					<div class="col-md-8 hidden-sm hidden-xs">
    						<div class="mainmenu">
                                <ul id="navigation">
    								<li class="<?php if($page_title == 'Home Page'){ echo "active"; }  ?>"><a href="{{url('/')}}">Home <i class="fa fa-home"></i></a></li>
    								<li class="<?php if($page_title == 'About Us'){ echo "active"; }  ?>"><a href="#">About Us <i class="fa fa-angle-down"></i></a>
                                        <ul class="submenu">
                                            
                                            <li><a href="{{url('/about-us')}}"><i class="fa fa-info"></i> Who We Are</a></li>
                                            <li><a href="{{url('/about-us')}}/team"><i class="fa fa-info"></i> Our Team </a></li>
                                     
                                        </ul>
                                    </li>
									<!-- <li class="<?php if($page_title == 'Our Services'){ echo "active"; }  ?>"><a href="{{url('/our-services')}}">Services <i class="fa fa-wrench"></i></a></li> -->
									<li class="<?php if($page_title == 'Sectors'){ echo "active"; }  ?>"><a href="#">Sectors <i class="fa fa-angle-down"></i></a>
    									<ul class="megamenu">
    										...
    										<li class="open">
											    <a class="mega-title" href="{{url('/our-sectors')}}/{{$sect->slung}}"><i class="fa fa-dot-circle-o"></i> {{$sect->title}}</a>
											</li>
											@endforeach
    									</ul>
									</li>
                                    <li class="<?php if($page_title == 'Contact Us'){ echo "active"; }  ?>"><a href="{{url('/our-properties')}}"> Properties <i class="fa fa-angle-down"></i></a>
                                        <ul class="submenu">
                                            ...
                                            @else
                                            <li><a  href="{{url('/')}}/properties/land">Land</a></li>
                                            @endif
                                            ...
                                            @else
                                            <li><a  href="{{url('/')}}/properties/Residential">Residential</a></li>
                                            @endif
                                    ...
                                    <!-- <li class="<?php if($page_title == 'Downloads'){ echo "active"; }  ?>"><a href="#">Downloads <i class="fa fa-angle-down"></i></a>
                                         <ul class="submenu">
                                             ...
                                             <li><a download href="{{url('/')}}/uploads/files/{{$file->file}}"><i class="fa fa-download"></i> {{$file->name}}</a></li>
                                             @endforeach
                                         </ul>
                                    </li> -->
                                    ...
                                    <li class="<?php if($page_title == 'Downloads'){ echo "active"; }  ?>"><a href="#">Media Center<i class="fa fa-angle-down"></i></a>
                                        <ul class="submenu">
                                            ...
                                            @foreach($Files as $file)
                                            <li><a href="{{url('/')}}/media-center/{{$file->slung}}"><i class="fa fa-check"></i> {{$file->title}}</a></li>
                                           
                                            
                                            @endforeach
                                            <li><a href="{{url('/')}}/media-centers/photo-gallery"><i class="fa fa-check"></i> Photo Gallery</a></li>
                                        </ul>
                                   </li> 
    								
    								<li class="<?php if($page_title == 'Contact Us'){ echo "active"; }  ?>"><a href="{{url('/contact-us')}}">Contact Us <i class="fa fa-phone"></i></a></li>
		...
		<footer>
			<div class="footer-top main_footer__block" style="background-image: url('{{url('/')}}/uploads/banners/{{$banner->image}}');">
				<div class="container">
					<div class="row text-center">
						<div class="col-md-5 col-sm-6 col-xs-12 col wow fadeInUp" data-wow-delay=".1s">
							...
							{{-- <p>Get regular updates on our product and services, random coupons and Discounts</p> --}}
                        ...
                        <div class="col-md-2 col-sm-6 col-xs-12 col wow fadeInUp" data-wow-delay=".2s">
                            <div class="footer-widget footer-menu">
                                ...
                                <ul>
                                    ...
                                    <li><a href="{{url('/our-sectors')}}">Sectors</a></li>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12 col wow fadeInUp" data-wow-delay=".1s">
							<div class="footer-widget footer-logo">
                                <h2>Contact Us</h2>
                                <ul>
                                    <li><i style="color:#6cd6fa" class="fa fa-book"></i> {{$Settings->address}}</li>
                                    <li><i style="color:#6cd6fa" class="fa fa-map-marker"></i> {{$Settings->location}}</li>
                                    <li><i style="color:#6cd6fa" class="fa fa-phone"></i> {{$Settings->mobile}} | {{$Settings->mobile_one}}</li>
                                    <li><i style="color:#6cd6fa" class="fa fa-envelope"></i> {{$Settings->email}}</li>
                                </ul>
							</div>
                        </div>
					</div>
...
Copyright &copy; <script>document.write(new Date().getFullYear());</script> <a  href="{{url('/copyright')}}">{{$Settings->sitename}}</a> All rights reserved
<!-- Link back to Designekta Studios can't be removed. Template is licensed under CC BY 3.0. -->
                        </div>
                    </div>
                </div>
		...
		<!-- counterup.main.js -->
        <script src="{{asset('theme/assets/js/counterup.main.js')}}"></script>
		<!-- isotope.pkgd.min.js -->
		...
		<!-- snake.min.js -->
        <script src="{{asset('theme/assets/js/snake.min.js')}}"></script>
		<!-- wow js -->
